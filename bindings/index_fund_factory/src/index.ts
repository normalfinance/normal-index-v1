...
export class Client extends ContractClient {
  static async deploy<T = Client>(
        ...
        {admin, emergency_admin, swap_utility, index_contract_wasm}: {admin: string, emergency_admin: string, swap_utility: string, index_contract_wasm: Buffer},
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAADUZhY3RvcnlDb25maWcAAAAAAAACAAAAAAAAABNpbmRleF9jb250cmFjdF93YXNtAAAAA+4AAAAgAAAAAAAAAAxzd2FwX3V0aWxpdHkAAAAT",
