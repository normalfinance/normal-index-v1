...
pub enum IndexError {
    ...
    PrivateConstraintVerificationNotSupported = 45,
    AuthorizedConstraintVerificationNotSupported = 46,
    RebalancingConstraintsViolated = 47,
    UnauthorizedPrivacyAccess = 48,
    EncryptionKeyNotFound = 49,
    DecryptionFailed = 50,
}
