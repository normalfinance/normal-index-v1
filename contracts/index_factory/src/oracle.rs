use soroban_sdk::{contractclient, contracttype, Address, Env, Symbol, Vec, panic_with_error, IntoVal};
...
impl OracleUtils {
    pub fn convert_xlm_to_usd(env: &Env, xlm_asset: &Address, xlm_amount: u128) -> u128 {
        ...
        xlm_amount.saturating_mul(xlm_price_usd).saturating_div(10_000_000)
    }
    ...
    pub fn get_xlm_price_usd(env: &Env, oracle_registry: &Address, xlm_asset: &Address) -> u128 {
        ...
        match result {
            Ok((historical_data, validity)) => {
                
                match validity {
                    OracleValidity::Valid => {
                        
                        historical_data.last_oracle_price
                    }
                    ...
                    OracleValidity::TooVolatile => {
                        ...
                        historical_data.last_oracle_price_twap
                    }
